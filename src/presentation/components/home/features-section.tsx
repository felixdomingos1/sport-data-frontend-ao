        ...
        {features.map((feature) => {
          ...
          return (
            <Link
              key={feature.title}
              to={feature.link}
              className="group bg-gray-100 dark:bg-[#0f0f0f] border border-gray-200 dark:border-[#1a1a1a] rounded-2xl p-6 hover:border-[#E60000]/30 transition"
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-500 leading-relaxed mb-4">{feature.description}</p>
